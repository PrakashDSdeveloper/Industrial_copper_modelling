...
with tab1:    
        ...
        if submit_button and flag==0:
            ...
            import pickle
            with open(r"data_source/model.pkl", 'rb') as file:
                loaded_model = pickle.load(file)
            with open(r'data_source/scaler.pkl', 'rb') as f:
                scaler_loaded = pickle.load(f)

            with open(r"data_source/t.pkl", 'rb') as f:
                t_loaded = pickle.load(f)

            with open(r"data_source/s.pkl", 'rb') as f:
...
with tab2: 
        ...
        if csubmit_button and cflag==0:
            import pickle
            with open(r"data_source/cmodel.pkl", 'rb') as file:
                cloaded_model = pickle.load(file)

            with open(r'data_source/cscaler.pkl', 'rb') as f:
                cscaler_loaded = pickle.load(f)

            with open(r"data_source/ct.pkl", 'rb') as f:
